 ...
 * Dao implementation.
 * <p>
 * <b>WARNING!</b> if you modify this class you have to delete manually and
 * re-generate {@link UserDaoVertxEBProxy} and {@link UserDaoVertxProxyHandler}
 * (mvn compile) because the processor would not re-generate it if class already
 * exists.
 * 
 * @author Pidji
 */
