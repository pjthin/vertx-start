...
public class ProxyfiedService {
	...
	/** true if deploy verticle */
	private boolean autoDeployVerticle;
	...
	public boolean isAutoDeployVerticle() {
		return autoDeployVerticle;
	}

	@Fluent
	public ProxyfiedService setAutoDeployVerticle(boolean autoDeployVerticle) {
